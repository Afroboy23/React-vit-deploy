...
import lookbook3 from "../assets/images/rbsprint.jpg";
  ...
  const products = [
    {
      ...
      price: "$120",
      label: "Limited Drop",
      imgPlaceholder: "HB", // We do not have hoodie vectors, so using typographic abstraction
      color: "bg-zinc-900"
    },
    {
    ...
    <div className="bg-black min-h-screen text-white font-sans overflow-x-hidden selection:bg-orange-500/30">
      ...
      <section className="relative w-full h-[90vh] flex flex-col items-center justify-center overflow-hidden pt-20">
        ...
        >
          ...
          <h1 className="text-6xl md:text-9xl font-black tracking-tighter mb-4 leading-none text-white">
            Run Buddy <br />
            <span className="text-zinc-500 font-light text-5xl md:text-7xl block my-4">×</span>
            Saved By Karlos
          </h1>
          <h2 className="text-2xl md:text-4xl font-light text-orange-500 tracking-tight mt-6 mb-8">
      ...
      <div className="w-full bg-orange-600 overflow-hidden py-4 border-y border-orange-500/50 relative z-20">
        <motion.div
        ...
        >
          {[...Array(6)].map((_, i) => (
            <div key={i} className="text-black font-black text-2xl md:text-3xl tracking-widest uppercase flex items-center gap-8">
              ...
              <span>CITY</span> <span className="w-2 h-2 bg-black rounded-full" />
              <span>ENERGY</span> <span className="w-2 h-2 bg-black rounded-full" />
            </div>
          ))}
        </motion.div>
      </div>
            ...
            {products.map((product, idx) => (
              ...
              >
                <div className={`relative aspect-square w-full rounded-[2rem] overflow-hidden ${product.color} border border-white/5 flex items-center justify-center mb-6 group-hover:border-orange-500/50 transition-colors duration-500`}>
                  ...
                  <div className="text-8xl font-black text-white/5 tracking-tighter group-hover:text-orange-500/10 transition-colors duration-700 group-hover:scale-110">
